...
public partial class trial_05082023 {
    ...
    public class UserLevelPermissions : DbTable, IQueryFactory
    {
        ...
        public bool ModalGridAdd = true;

        public bool ModalGridEdit = true;

        public bool ModalMultiEdit = false;

        public readonly DbField<NpgsqlDbType> UserLevelID;

        public readonly DbField<NpgsqlDbType> _TableName;

        public readonly DbField<NpgsqlDbType> Permission;
        ...
        public UserLevelPermissions()
        {
            ...
            // UserLevelID
            UserLevelID = new (this, "x_UserLevelID", 3, NpgsqlDbType.Integer) {
                Name = "UserLevelID",
                Expression = "\"UserLevelID\"",
                BasicSearchExpression = "CAST(\"UserLevelID\" AS varchar(255))",
                DateTimeFormat = -1,
            ...
            // TableName
            _TableName = new (this, "x__TableName", 200, NpgsqlDbType.Varchar) {
                Name = "TableName",
            ...
            // Permission
            Permission = new (this, "x_Permission", 3, NpgsqlDbType.Integer) {
                Name = "Permission",
                Expression = "\"Permission\"",
                BasicSearchExpression = "CAST(\"Permission\" AS varchar(255))",
                DateTimeFormat = -1,
