...
public partial class trial_05082023 {
    ...
    public static object? Invoke(string name, object?[]? parameters = null) =>
        typeof(trial_05082023).GetMethod(name)?.Invoke(null, parameters);
    ...
    public static object? GetPropertyValue(string name) =>
        typeof(trial_05082023).GetProperty(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy | BindingFlags.Instance)?.GetValue(null);
