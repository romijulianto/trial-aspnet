...
public partial class trial_05082023 {
    ...
    public class UserLevels : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<NpgsqlDbType> UserLevelName;
        ...
        public UserLevels()
        {
            ...
            Name = "UserLevels";
            Type = "TABLE";
            UpdateTable = "UserLevels"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // UserLevelName
            UserLevelName = new (this, "x_UserLevelName", 200, NpgsqlDbType.Varchar) {
                Name = "UserLevelName",
