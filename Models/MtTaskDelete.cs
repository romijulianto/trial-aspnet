...
public partial class trial_05082023 {
    ...
    /// mtTaskDelete
    /// </summary>
    public static MtTaskDelete mtTaskDelete
    {
        get => HttpData.Get<MtTaskDelete>("mtTaskDelete")!;
        set => HttpData["mtTaskDelete"] = value;
    }

    /// <summary>
    /// Page class for mt_task
    /// </summary>
    public class MtTaskDelete : MtTaskDeleteBase
    {
        // Constructor
        public MtTaskDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtTaskDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtTaskDeleteBase : MtTask
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtTaskDelete";
        ...
        // Page name
        public string PageName => "mttaskdelete";
        ...
        // Constructor
        public MtTaskDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("mttasklist"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("mttasklist"); // Return to list
                }
            }
        ...
        protected async Task<JsonBoolResult> DeleteRows() { // DN
            ...
            if (result) {
                ...
                string subject = table + " " + Language.Phrase("RecordDeleted");
                string action = Language.Phrase("ActionDeleted");
                var email = new Email();
                ...
                if (EmailSending(email, ConvertToDictionary<dynamic>(new { rs = rsold })))
