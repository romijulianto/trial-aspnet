...
public partial class trial_05082023 {
    ...
    /// mtTaskEdit
    /// </summary>
    public static MtTaskEdit mtTaskEdit
    {
        get => HttpData.Get<MtTaskEdit>("mtTaskEdit")!;
        set => HttpData["mtTaskEdit"] = value;
    }

    /// <summary>
    /// Page class for mt_task
    /// </summary>
    public class MtTaskEdit : MtTaskEditBase
    {
        // Constructor
        public MtTaskEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtTaskEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtTaskEditBase : MtTask
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtTaskEdit";
        ...
        // Page name
        public string PageName => "mttaskedit";
        ...
        // Constructor
        public MtTaskEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("mttasklist"); // No matching record, return to list
                        }
                    break;
                case "update": // Update // DN
                    CloseRecordset(); // DN
                    string returnUrl = "mttasklist";
