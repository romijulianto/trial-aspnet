...
public partial class trial_05082023 {
    ...
    /// mtTaskView
    /// </summary>
    public static MtTaskView mtTaskView
    {
        get => HttpData.Get<MtTaskView>("mtTaskView")!;
        set => HttpData["mtTaskView"] = value;
    }

    /// <summary>
    /// Page class for mt_task
    /// </summary>
    public class MtTaskView : MtTaskViewBase
    {
        // Constructor
        public MtTaskView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtTaskView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtTaskViewBase : MtTask
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtTaskView";
        ...
        // Page name
        public string PageName => "mttaskview";
        ...
        // Constructor
        public MtTaskViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "mttasklist"; // Return to list
            }
                    ...
                    if (!IsModal) { // Normal view page
                        ...
                        if (TotalRecords <= 0) { // No record found // DN
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("mttasklist"); // Return to list page
                            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fmt_taskview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("mttasklist")), "", TableVar, true);
            string pageId = "view";
