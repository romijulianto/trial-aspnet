...
public partial class trial_05082023 {
    ...
    /// mtTaskAdd
    /// </summary>
    public static MtTaskAdd mtTaskAdd
    {
        get => HttpData.Get<MtTaskAdd>("mtTaskAdd")!;
        set => HttpData["mtTaskAdd"] = value;
    }

    /// <summary>
    /// Page class for mt_task
    /// </summary>
    public class MtTaskAdd : MtTaskAddBase
    {
        // Constructor
        public MtTaskAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public MtTaskAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class MtTaskAddBase : MtTask
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "mtTaskAdd";
        ...
        // Page name
        public string PageName => "mttaskadd";
        ...
        // Constructor
        public MtTaskAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("mttasklist"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = AddUrl;
                        if (GetPageName(returnUrl) == "mttasklist")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "mttaskview")
                        ...
                        if (IsModal && UseAjaxActions) {
                            ...
                            if (GetPageName(returnUrl) != "mttasklist") {
                                ...
                                returnUrl = "mttasklist"; // Return list page content
                            }
                        }
        ...
        public async Task RenderRow()
        {
            ...
            // deadline
            deadline.RowCssClass = "row";

            // createat
            createat.RowCssClass = "row";

            // updateat
            updateat.RowCssClass = "row";
